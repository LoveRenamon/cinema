<<<<<<< HEAD:workshop/gamemodes/cinema/entities/entities/theater_door/cl_init.lua
include("sh_init.lua")
...
hook.Add( "RenderScreenspaceEffects", "theater_render_loading", function()
	...
	clr["$$pp_colour_colour"] = ent.Alpha
	DrawColorModify( clr )
>>>>>>> fa56e4c (moved files):gamemode/modules/theater/ents/entities/theater_door/cl_init.lua
end )