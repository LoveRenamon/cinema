<<<<<<< HEAD:workshop/gamemodes/cinema/gamemode/modules/scoreboard/controls/cl_checkboxlabel.lua
local PANEL = {}
...
derma.DefineControl( "TheaterCheckBoxLabel", "", PANEL, "DCheckBoxLabel" )
>>>>>>> fa56e4c (moved files):gamemode/modules/scoreboard/controls/cl_checkboxlabel.lua
