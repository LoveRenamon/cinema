<<<<<<< HEAD:workshop/gamemodes/cinema/gamemode/modules/scoreboard/controls/cl_numslider.lua
/*   _
    ( )
...
derma.DefineControl( "TheaterNumSlider", "A simple slider", PANEL, "Panel" )
>>>>>>> fa56e4c (moved files):gamemode/modules/scoreboard/controls/cl_numslider.lua
