<<<<<<< HEAD:workshop/gamemodes/cinema/entities/entities/theater_thumbnail/cl_init.lua
include('sh_init.lua')
...
>>>>>>> fa56e4c (moved files):gamemode/modules/theater/ents/entities/theater_thumbnail/cl_init.lua
end